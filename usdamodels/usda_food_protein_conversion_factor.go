...
var (
	...
	usdaFoodProteinConversionFactorColumnsWithoutDefault = []string{"food_nutrient_conversion_factor_id"}
	usdaFoodProteinConversionFactorColumnsWithDefault    = []string{"value"}
	usdaFoodProteinConversionFactorPrimaryKeyColumns     = []string{"food_nutrient_conversion_factor_id"}
	usdaFoodProteinConversionFactorGeneratedColumns      = []string{}
)
...
func (q usdaFoodProteinConversionFactorQuery) One(ctx context.Context, exec boil.ContextExecutor) (*UsdaFoodProteinConversionFactor, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "usdamodels: failed to execute a one query for usda_food_protein_conversion_factor")
	}
...
func (q usdaFoodProteinConversionFactorQuery) All(ctx context.Context, exec boil.ContextExecutor) (UsdaFoodProteinConversionFactorSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "usdamodels: failed to assign all query results to UsdaFoodProteinConversionFactor slice")
	}
...
func (q usdaFoodProteinConversionFactorQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "usdamodels: failed to count usda_food_protein_conversion_factor rows")
	}
...
func (q usdaFoodProteinConversionFactorQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "usdamodels: failed to check if usda_food_protein_conversion_factor exists")
	}
...
func UsdaFoodProteinConversionFactors(mods ...qm.QueryMod) usdaFoodProteinConversionFactorQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"\"usda_food_protein_conversion_factor\".*"})
	}

	return usdaFoodProteinConversionFactorQuery{q}
}
...
func FindUsdaFoodProteinConversionFactor(ctx context.Context, exec boil.ContextExecutor, foodNutrientConversionFactorID int, selectCols ...string) (*UsdaFoodProteinConversionFactor, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "usdamodels: unable to select from usda_food_protein_conversion_factor")
	}
...
func (o *UsdaFoodProteinConversionFactor) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("usdamodels: no usda_food_protein_conversion_factor provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "usdamodels: unable to insert into usda_food_protein_conversion_factor")
	}
...
func (o *UsdaFoodProteinConversionFactor) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("usdamodels: unable to update usda_food_protein_conversion_factor, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "usdamodels: unable to update usda_food_protein_conversion_factor row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "usdamodels: failed to get rows affected by update for usda_food_protein_conversion_factor")
	}
...
func (q usdaFoodProteinConversionFactorQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "usdamodels: unable to update all for usda_food_protein_conversion_factor")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "usdamodels: unable to retrieve rows affected for usda_food_protein_conversion_factor")
	}
...
func (o UsdaFoodProteinConversionFactorSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "usdamodels: unable to update all in usdaFoodProteinConversionFactor slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "usdamodels: unable to retrieve rows affected all in update all usdaFoodProteinConversionFactor")
	}
	return rowsAff, nil
}
...
func (o *UsdaFoodProteinConversionFactor) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("usdamodels: no usda_food_protein_conversion_factor provided for upsert")
	}
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("usdamodels: unable to upsert usda_food_protein_conversion_factor, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "usdamodels: unable to upsert usda_food_protein_conversion_factor")
	}
...
func (o *UsdaFoodProteinConversionFactor) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("usdamodels: no UsdaFoodProteinConversionFactor provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "usdamodels: unable to delete from usda_food_protein_conversion_factor")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "usdamodels: failed to get rows affected by delete for usda_food_protein_conversion_factor")
	}
...
func (q usdaFoodProteinConversionFactorQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("usdamodels: no usdaFoodProteinConversionFactorQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "usdamodels: unable to delete all from usda_food_protein_conversion_factor")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "usdamodels: failed to get rows affected by deleteall for usda_food_protein_conversion_factor")
	}
...
func (o UsdaFoodProteinConversionFactorSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "usdamodels: unable to delete all from usdaFoodProteinConversionFactor slice")
	}
...
func (o *UsdaFoodProteinConversionFactorSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "usdamodels: unable to reload all in UsdaFoodProteinConversionFactorSlice")
	}
...
func UsdaFoodProteinConversionFactorExists(ctx context.Context, exec boil.ContextExecutor, foodNutrientConversionFactorID int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "usdamodels: unable to check if usda_food_protein_conversion_factor exists")
	}
