...
var UsdaFoodRels = struct {
	...
	FDCUsdaFoodNutrients:                 "FDCUsdaFoodNutrients",
...
type usdaFoodR struct {
	...
	FDCUsdaFoodNutrients                 UsdaFoodNutrientSlice                 `boil:"FDCUsdaFoodNutrients" json:"FDCUsdaFoodNutrients" toml:"FDCUsdaFoodNutrients" yaml:"FDCUsdaFoodNutrients"`
...
var (
	...
	usdaFoodColumnsWithoutDefault = []string{"fdc_id"}
	usdaFoodColumnsWithDefault    = []string{"data_type", "description", "food_category_id", "publication_date"}
	usdaFoodPrimaryKeyColumns     = []string{"fdc_id"}
	usdaFoodGeneratedColumns      = []string{}
)
...
func (q usdaFoodQuery) One(ctx context.Context, exec boil.ContextExecutor) (*UsdaFood, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "usdamodels: failed to execute a one query for usda_food")
	}
...
func (q usdaFoodQuery) All(ctx context.Context, exec boil.ContextExecutor) (UsdaFoodSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "usdamodels: failed to assign all query results to UsdaFood slice")
	}
...
func (q usdaFoodQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "usdamodels: failed to count usda_food rows")
	}
...
func (q usdaFoodQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "usdamodels: failed to check if usda_food exists")
	}
...
func (o *UsdaFood) FDCUsdaBrandedFood(mods ...qm.QueryMod) usdaBrandedFoodQuery {
	...
	return UsdaBrandedFoods(queryMods...)
}
...
func (o *UsdaFood) FDCUsdaFoundationFood(mods ...qm.QueryMod) usdaFoundationFoodQuery {
	...
	return UsdaFoundationFoods(queryMods...)
}
...
func (o *UsdaFood) FDCUsdaMarketAcquisition(mods ...qm.QueryMod) usdaMarketAcquisitionQuery {
	...
	return UsdaMarketAcquisitions(queryMods...)
}
...
func (o *UsdaFood) FDCUsdaSampleFood(mods ...qm.QueryMod) usdaSampleFoodQuery {
	...
	return UsdaSampleFoods(queryMods...)
}
...
func (o *UsdaFood) FDCUsdaSRLegacyFood(mods ...qm.QueryMod) usdaSRLegacyFoodQuery {
	...
	return UsdaSRLegacyFoods(queryMods...)
}
...
func (o *UsdaFood) FDCUsdaSubSampleFood(mods ...qm.QueryMod) usdaSubSampleFoodQuery {
	...
	return UsdaSubSampleFoods(queryMods...)
}
...
func (o *UsdaFood) FDCUsdaFoodComponents(mods ...qm.QueryMod) usdaFoodComponentQuery {
	...
	return UsdaFoodComponents(queryMods...)
}

// FDCUsdaFoodNutrients retrieves all the usda_food_nutrient's UsdaFoodNutrients with an executor via fdc_id column.
func (o *UsdaFood) FDCUsdaFoodNutrients(mods ...qm.QueryMod) usdaFoodNutrientQuery {
	var queryMods []qm.QueryMod
	if len(mods) != 0 {
		queryMods = append(queryMods, mods...)
	}
	...
	queryMods = append(queryMods,
		qm.Where("\"usda_food_nutrient\".\"fdc_id\"=?", o.FDCID),
	)
...
func (o *UsdaFood) FDCUsdaFoodNutrientConversionFactors(mods ...qm.QueryMod) usdaFoodNutrientConversionFactorQuery {
	...
	return UsdaFoodNutrientConversionFactors(queryMods...)
}
...
func (o *UsdaFood) FDCUsdaFoodPortions(mods ...qm.QueryMod) usdaFoodPortionQuery {
	...
	return UsdaFoodPortions(queryMods...)
}
...
func (o *UsdaFood) FDCUsdaInputFoods(mods ...qm.QueryMod) usdaInputFoodQuery {
	...
	return UsdaInputFoods(queryMods...)
}
...
// LoadFDCUsdaFoodNutrients allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (usdaFoodL) LoadFDCUsdaFoodNutrients(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUsdaFood interface{}, mods queries.Applicator) error {
	var slice []*UsdaFood
	var object *UsdaFood
	...
	query := NewQuery(
		...
		qm.WhereIn(`usda_food_nutrient.fdc_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
	...
	if singular {
		object.R.FDCUsdaFoodNutrients = resultSlice
		for _, foreign := range resultSlice {
			if foreign.R == nil {
	...
	for _, foreign := range resultSlice {
		for _, local := range slice {
			if queries.Equal(local.FDCID, foreign.FDCID) {
				local.R.FDCUsdaFoodNutrients = append(local.R.FDCUsdaFoodNutrients, foreign)
				if foreign.R == nil {
					foreign.R = &usdaFoodNutrientR{}
				}
				foreign.R.FDC = local
...
// AddFDCUsdaFoodNutrients adds the given related objects to the existing relationships
// of the usda_food, optionally inserting them as new records.
// Appends related to o.R.FDCUsdaFoodNutrients.
// Sets related.R.FDC appropriately.
func (o *UsdaFood) AddFDCUsdaFoodNutrients(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*UsdaFoodNutrient) error {
	var err error
	for _, rel := range related {
		if insert {
			queries.Assign(&rel.FDCID, o.FDCID)
	...
	if o.R == nil {
		o.R = &usdaFoodR{
			FDCUsdaFoodNutrients: related,
		}
	} else {
		o.R.FDCUsdaFoodNutrients = append(o.R.FDCUsdaFoodNutrients, related...)
	}
...
// SetFDCUsdaFoodNutrients removes all previously related items of the
// usda_food replacing them completely with the passed
// in related items, optionally inserting them as new records.
// Sets o.R.FDC's FDCUsdaFoodNutrients accordingly.
// Replaces o.R.FDCUsdaFoodNutrients with related.
// Sets related.R.FDC's FDCUsdaFoodNutrients accordingly.
func (o *UsdaFood) SetFDCUsdaFoodNutrients(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*UsdaFoodNutrient) error {
	query := "update \"usda_food_nutrient\" set \"fdc_id\" = null where \"fdc_id\" = $1"
	values := []interface{}{o.FDCID}
	if boil.IsDebug(ctx) {
		writer := boil.DebugWriterFrom(ctx)
		fmt.Fprintln(writer, query)
	...
	if o.R != nil {
		for _, rel := range o.R.FDCUsdaFoodNutrients {
			queries.SetScanner(&rel.FDCID, nil)
			if rel.R == nil {
				continue
			}
		...
		o.R.FDCUsdaFoodNutrients = nil
	}

	return o.AddFDCUsdaFoodNutrients(ctx, exec, insert, related...)
}

// RemoveFDCUsdaFoodNutrients relationships from objects passed in.
// Removes related items from R.FDCUsdaFoodNutrients (uses pointer comparison, removal does not keep order)
// Sets related.R.FDC.
func (o *UsdaFood) RemoveFDCUsdaFoodNutrients(ctx context.Context, exec boil.ContextExecutor, related ...*UsdaFoodNutrient) error {
	if len(related) == 0 {
		return nil
	}
	...
	for _, rel := range related {
		for i, ri := range o.R.FDCUsdaFoodNutrients {
			if rel != ri {
				continue
			}

			ln := len(o.R.FDCUsdaFoodNutrients)
			if ln > 1 && i < ln-1 {
				o.R.FDCUsdaFoodNutrients[i] = o.R.FDCUsdaFoodNutrients[ln-1]
			}
			o.R.FDCUsdaFoodNutrients = o.R.FDCUsdaFoodNutrients[:ln-1]
			break
		}
	}
...
func UsdaFoods(mods ...qm.QueryMod) usdaFoodQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"\"usda_food\".*"})
	}

	return usdaFoodQuery{q}
}
...
func FindUsdaFood(ctx context.Context, exec boil.ContextExecutor, fDCID int, selectCols ...string) (*UsdaFood, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "usdamodels: unable to select from usda_food")
	}
...
func (o *UsdaFood) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("usdamodels: no usda_food provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "usdamodels: unable to insert into usda_food")
	}
...
func (o *UsdaFood) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("usdamodels: unable to update usda_food, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "usdamodels: unable to update usda_food row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "usdamodels: failed to get rows affected by update for usda_food")
	}
...
func (q usdaFoodQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "usdamodels: unable to update all for usda_food")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "usdamodels: unable to retrieve rows affected for usda_food")
	}
...
func (o UsdaFoodSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "usdamodels: unable to update all in usdaFood slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "usdamodels: unable to retrieve rows affected all in update all usdaFood")
	}
	return rowsAff, nil
}
...
func (o *UsdaFood) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("usdamodels: no usda_food provided for upsert")
	}
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("usdamodels: unable to upsert usda_food, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "usdamodels: unable to upsert usda_food")
	}
...
func (o *UsdaFood) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("usdamodels: no UsdaFood provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "usdamodels: unable to delete from usda_food")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "usdamodels: failed to get rows affected by delete for usda_food")
	}
...
func (q usdaFoodQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("usdamodels: no usdaFoodQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "usdamodels: unable to delete all from usda_food")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "usdamodels: failed to get rows affected by deleteall for usda_food")
	}
...
func (o UsdaFoodSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "usdamodels: unable to delete all from usdaFood slice")
	}
...
func (o *UsdaFoodSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "usdamodels: unable to reload all in UsdaFoodSlice")
	}
...
func UsdaFoodExists(ctx context.Context, exec boil.ContextExecutor, fDCID int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "usdamodels: unable to check if usda_food exists")
	}
