...
class EditorPage extends Component {
  ...
  editInstruction(sectionNum,instructionNum,e) {
      this.props.editInstruction(this.state.slug,sectionNum,instructionNum,e.target.value)
  }
  ...
  editIngredient(sectionNum,ingredientNum,field,e) {
      this.props.editIngredient(this.state.slug, sectionNum,ingredientNum,field,e.target.value)
  }
  render() {
      ...
      <div className="row">
        ...
        <div className="form-group row">
          ...
          <div className="col-10">
            <input className="form-control" type="text" value={recipe.title} onChange={this.editTopLevelItem.bind(this,'title')} />
          </div>
        </div>
        ...
        <div className="form-group row">
          ...
          <div className="col-10">
            <input className="form-control" type="text" value={recipe.source} onChange={this.editTopLevelItem.bind(this,'source')} />
          </div>
        </div>
        ...
        <div className="form-group row">
          ...
          <div className="col-10">
            <input className="form-control" type="number" value={recipe.quantity} onChange={this.editTopLevelItem.bind(this,'quantity')} />
          </div>
        </div>
        ...
        <div className="form-group row">
          ...
          <div className="col-10">
            <input className="form-control" type="number" value={recipe.servings} onChange={this.editTopLevelItem.bind(this,'servings')} />
          </div>
        </div>
        ...
        <div className="form-group row">
          ...
          <div className="col-10">
            <input className="form-control" type="number" value={recipe.total_minutes} onChange={this.editTopLevelItem.bind(this,'total_minutes')} />
          </div>
        </div>
