...
generate-openapi: validate-openapi
	rm -rf ui/src/api/openapi-*
	# https://github.com/OpenAPITools/openapi-generator/issues/3869#issuecomment-584152932
	openapi-generator generate -i api/openapi.yaml -o ui/src/api/openapi-fetch -g typescript-fetch --additional-properties=typescriptThreePlus=true,supportsES6=true,enumPropertyNaming=UPPERCASE
	# openapi-generator generate -i api/openapi.yaml -o ui/src/api/openapi-fetch -g typescript --additional-properties=supportsES6=true
	go generate ./api
