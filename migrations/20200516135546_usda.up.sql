...
CREATE TABLE IF NOT EXISTS acquisition_sample (
...
CREATE INDEX IF NOT EXISTS idx_branded_food_branded_food_category ON branded_food (branded_food_category);
...
CREATE INDEX IF NOT EXISTS idx_food_attribute_fdc_id                 ON food_attribute (fdc_id);
CREATE INDEX IF NOT EXISTS idx_food_attribute_food_attribute_type_id ON food_attribute (food_attribute_type_id);
...
CREATE INDEX IF NOT EXISTS idx_food_nutrient_conversion_factor_fdc_id ON food_nutrient_conversion_factor (fdc_id);
...
CREATE INDEX IF NOT EXISTS idx_food_nutrient_derivation_source_id ON food_nutrient_derivation (source_id);
...
CREATE INDEX IF NOT EXISTS idx_food_nutrient_derivation_id  ON food_nutrient (derivation_id);
CREATE INDEX IF NOT EXISTS idx_food_nutrient_fcd_id  ON food_nutrient (fdc_id); -- new
...
CREATE INDEX IF NOT EXISTS idx_food_portion_fcd_id  ON food_portion (fdc_id); -- new
...
CREATE TABLE IF NOT EXISTS foundation_food (
  "fdc_id"     INT NOT NULL PRIMARY KEY REFERENCES food(fdc_id),
  "ndb_number" INT, -- not rlly unique
  "footnote"   TEXT
);
...
CREATE INDEX IF NOT EXISTS idx_input_food_fdc_id_of_input_food ON input_food (fdc_id_of_input_food);
...
CREATE INDEX IF NOT EXISTS idx_lab_method_code_lab_method_id ON lab_method_code (lab_method_id);
...
CREATE INDEX IF NOT EXISTS idx_lab_method_nutrient_lab_method_id ON lab_method_nutrient (lab_method_id);
...
CREATE INDEX IF NOT EXISTS idx_nutrient_incoming_name_nutrient_id ON nutrient_incoming_name (nutrient_id);
...
CREATE INDEX IF NOT EXISTS idx_retention_factor_food_group_id ON retention_factor (food_group_id);
...
CREATE INDEX IF NOT EXISTS idx_sub_sample_food_fdc_id_of_sample_food ON sub_sample_food (fdc_id_of_sample_food);
...
CREATE INDEX IF NOT EXISTS idx_sub_sample_result_lab_method_id ON sub_sample_result (lab_method_id);
...
CREATE INDEX IF NOT EXISTS idx_survey_fndds_food_wweia_category_code ON survey_fndds_food (wweia_category_code);
