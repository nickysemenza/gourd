...
var (
	...
	usdaMeasureUnitColumnsWithoutDefault = []string{"id"}
	usdaMeasureUnitColumnsWithDefault    = []string{"name"}
	usdaMeasureUnitPrimaryKeyColumns     = []string{"id"}
	usdaMeasureUnitGeneratedColumns      = []string{}
)
...
func (q usdaMeasureUnitQuery) One(ctx context.Context, exec boil.ContextExecutor) (*UsdaMeasureUnit, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "usdamodels: failed to execute a one query for usda_measure_unit")
	}
...
func (q usdaMeasureUnitQuery) All(ctx context.Context, exec boil.ContextExecutor) (UsdaMeasureUnitSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "usdamodels: failed to assign all query results to UsdaMeasureUnit slice")
	}
...
func (q usdaMeasureUnitQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "usdamodels: failed to count usda_measure_unit rows")
	}
...
func (q usdaMeasureUnitQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "usdamodels: failed to check if usda_measure_unit exists")
	}
...
func UsdaMeasureUnits(mods ...qm.QueryMod) usdaMeasureUnitQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"\"usda_measure_unit\".*"})
	}

	return usdaMeasureUnitQuery{q}
}
...
func FindUsdaMeasureUnit(ctx context.Context, exec boil.ContextExecutor, iD int, selectCols ...string) (*UsdaMeasureUnit, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "usdamodels: unable to select from usda_measure_unit")
	}
...
func (o *UsdaMeasureUnit) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("usdamodels: no usda_measure_unit provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "usdamodels: unable to insert into usda_measure_unit")
	}
...
func (o *UsdaMeasureUnit) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("usdamodels: unable to update usda_measure_unit, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "usdamodels: unable to update usda_measure_unit row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "usdamodels: failed to get rows affected by update for usda_measure_unit")
	}
...
func (q usdaMeasureUnitQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "usdamodels: unable to update all for usda_measure_unit")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "usdamodels: unable to retrieve rows affected for usda_measure_unit")
	}
...
func (o UsdaMeasureUnitSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "usdamodels: unable to update all in usdaMeasureUnit slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "usdamodels: unable to retrieve rows affected all in update all usdaMeasureUnit")
	}
	return rowsAff, nil
}
...
func (o *UsdaMeasureUnit) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("usdamodels: no usda_measure_unit provided for upsert")
	}
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("usdamodels: unable to upsert usda_measure_unit, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "usdamodels: unable to upsert usda_measure_unit")
	}
...
func (o *UsdaMeasureUnit) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("usdamodels: no UsdaMeasureUnit provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "usdamodels: unable to delete from usda_measure_unit")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "usdamodels: failed to get rows affected by delete for usda_measure_unit")
	}
...
func (q usdaMeasureUnitQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("usdamodels: no usdaMeasureUnitQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "usdamodels: unable to delete all from usda_measure_unit")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "usdamodels: failed to get rows affected by deleteall for usda_measure_unit")
	}
...
func (o UsdaMeasureUnitSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "usdamodels: unable to delete all from usdaMeasureUnit slice")
	}
...
func (o *UsdaMeasureUnitSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "usdamodels: unable to reload all in UsdaMeasureUnitSlice")
	}
...
func UsdaMeasureUnitExists(ctx context.Context, exec boil.ContextExecutor, iD int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "usdamodels: unable to check if usda_measure_unit exists")
	}
