...
var (
	...
	recipeSectionIngredientColumnsWithoutDefault = []string{"id", "section_id", "amounts"}
	recipeSectionIngredientColumnsWithDefault    = []string{"sort", "ingredient_id", "recipe_id", "adjective", "original", "optional", "sub_for_ingredient_id"}
	recipeSectionIngredientPrimaryKeyColumns     = []string{"id"}
	recipeSectionIngredientGeneratedColumns      = []string{}
)
...
func RecipeSectionIngredients(mods ...qm.QueryMod) recipeSectionIngredientQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"\"recipe_section_ingredients\".*"})
	}

	return recipeSectionIngredientQuery{q}
}
