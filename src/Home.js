    ...
    return (
      <div>
        ...
        <div className="row">
          ...
          <div className="col">
            <iframe
              src="http://www.nicky.photos/frame/slideshow?key=NrsTC5&autoStart=1&captions=1&navigation=1&playButton=0&randomize=1&speed=3&transition=fade&transitionSpeed=1"
              width="100%"
              height="600"
              frameBorder="no"
              scrolling="no"
