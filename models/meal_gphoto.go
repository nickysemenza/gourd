...
var (
	...
	mealGphotoColumnsWithoutDefault = []string{"meal_id", "gphotos_id"}
	mealGphotoColumnsWithDefault    = []string{"highlight_recipe_id"}
...
func MealGphotos(mods ...qm.QueryMod) mealGphotoQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"\"meal_gphoto\".*"})
	}

	return mealGphotoQuery{q}
}
