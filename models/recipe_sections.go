...
func (o *RecipeSection) SectionRecipeSectionInstructions(mods ...qm.QueryMod) recipeSectionInstructionQuery {
	...
	queries.SetFrom(query.Query, "\"recipe_section_instructions\"")

	if len(queries.GetSelect(query.Query)) == 0 {
		queries.SetSelect(query.Query, []string{"\"recipe_section_instructions\".*"})
	}
...
func RecipeSections(mods ...qm.QueryMod) recipeSectionQuery {
	...
	return recipeSectionQuery{NewQuery(mods...)}
}
