...
var (
	...
	usdaFoodCalorieConversionFactorColumnsWithoutDefault = []string{"food_nutrient_conversion_factor_id", "protein_value", "fat_value", "carbohydrate_value"}
	usdaFoodCalorieConversionFactorColumnsWithDefault    = []string{}
...
func (q usdaFoodCalorieConversionFactorQuery) One(ctx context.Context, exec boil.ContextExecutor) (*UsdaFoodCalorieConversionFactor, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: failed to execute a one query for usda_food_calorie_conversion_factor")
	}
...
func (q usdaFoodCalorieConversionFactorQuery) All(ctx context.Context, exec boil.ContextExecutor) (UsdaFoodCalorieConversionFactorSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "models: failed to assign all query results to UsdaFoodCalorieConversionFactor slice")
	}
...
func (q usdaFoodCalorieConversionFactorQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "models: failed to count usda_food_calorie_conversion_factor rows")
	}
...
func (q usdaFoodCalorieConversionFactorQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "models: failed to check if usda_food_calorie_conversion_factor exists")
	}
...
func UsdaFoodCalorieConversionFactors(mods ...qm.QueryMod) usdaFoodCalorieConversionFactorQuery {
	...
	return usdaFoodCalorieConversionFactorQuery{NewQuery(mods...)}
}
...
func FindUsdaFoodCalorieConversionFactor(ctx context.Context, exec boil.ContextExecutor, foodNutrientConversionFactorID int, selectCols ...string) (*UsdaFoodCalorieConversionFactor, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: unable to select from usda_food_calorie_conversion_factor")
	}
...
func (o *UsdaFoodCalorieConversionFactor) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("models: no usda_food_calorie_conversion_factor provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to insert into usda_food_calorie_conversion_factor")
	}
...
func (o *UsdaFoodCalorieConversionFactor) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("models: unable to update usda_food_calorie_conversion_factor, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to update usda_food_calorie_conversion_factor row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "models: failed to get rows affected by update for usda_food_calorie_conversion_factor")
	}
...
func (q usdaFoodCalorieConversionFactorQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to update all for usda_food_calorie_conversion_factor")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to retrieve rows affected for usda_food_calorie_conversion_factor")
	}
...
func (o UsdaFoodCalorieConversionFactorSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to update all in usdaFoodCalorieConversionFactor slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to retrieve rows affected all in update all usdaFoodCalorieConversionFactor")
	}
	return rowsAff, nil
}
...
func (o *UsdaFoodCalorieConversionFactor) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("models: no usda_food_calorie_conversion_factor provided for upsert")
	}
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("models: unable to upsert usda_food_calorie_conversion_factor, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to upsert usda_food_calorie_conversion_factor")
	}
...
func (o *UsdaFoodCalorieConversionFactor) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("models: no UsdaFoodCalorieConversionFactor provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to delete from usda_food_calorie_conversion_factor")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "models: failed to get rows affected by delete for usda_food_calorie_conversion_factor")
	}
...
func (q usdaFoodCalorieConversionFactorQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("models: no usdaFoodCalorieConversionFactorQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to delete all from usda_food_calorie_conversion_factor")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "models: failed to get rows affected by deleteall for usda_food_calorie_conversion_factor")
	}
...
func (o UsdaFoodCalorieConversionFactorSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to delete all from usdaFoodCalorieConversionFactor slice")
	}
...
func (o *UsdaFoodCalorieConversionFactorSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to reload all in UsdaFoodCalorieConversionFactorSlice")
	}
...
func UsdaFoodCalorieConversionFactorExists(ctx context.Context, exec boil.ContextExecutor, foodNutrientConversionFactorID int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "models: unable to check if usda_food_calorie_conversion_factor exists")
	}
