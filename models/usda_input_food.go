...
var (
	...
	usdaInputFoodColumnsWithoutDefault = []string{"id", "fdc_id", "fdc_id_of_input_food", "seq_num", "amount", "sr_code", "sr_description", "unit", "portion_code", "portion_description", "gram_weight", "retention_code", "survey_flag"}
	usdaInputFoodColumnsWithDefault    = []string{}
...
func UsdaInputFoods(mods ...qm.QueryMod) usdaInputFoodQuery {
	...
	return usdaInputFoodQuery{NewQuery(mods...)}
}
