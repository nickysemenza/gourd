...
var (
	...
	usdaFoodNutrientRawColumnsWithoutDefault = []string{"id", "fdc_id", "nutrient_id", "amount", "data_points", "derivation_id", "min", "max", "median", "loq", "footnote", "min_year_acquired"}
	usdaFoodNutrientRawColumnsWithDefault    = []string{}
...
func (q usdaFoodNutrientRawQuery) One(ctx context.Context, exec boil.ContextExecutor) (*UsdaFoodNutrientRaw, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: failed to execute a one query for usda_food_nutrient_raw")
	}
...
func (q usdaFoodNutrientRawQuery) All(ctx context.Context, exec boil.ContextExecutor) (UsdaFoodNutrientRawSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "models: failed to assign all query results to UsdaFoodNutrientRaw slice")
	}
...
func (q usdaFoodNutrientRawQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "models: failed to count usda_food_nutrient_raw rows")
	}
...
func (q usdaFoodNutrientRawQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "models: failed to check if usda_food_nutrient_raw exists")
	}
...
func UsdaFoodNutrientRaws(mods ...qm.QueryMod) usdaFoodNutrientRawQuery {
	...
	return usdaFoodNutrientRawQuery{NewQuery(mods...)}
}
...
func FindUsdaFoodNutrientRaw(ctx context.Context, exec boil.ContextExecutor, iD int, selectCols ...string) (*UsdaFoodNutrientRaw, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: unable to select from usda_food_nutrient_raw")
	}
...
func (o *UsdaFoodNutrientRaw) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("models: no usda_food_nutrient_raw provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to insert into usda_food_nutrient_raw")
	}
...
func (o *UsdaFoodNutrientRaw) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("models: unable to update usda_food_nutrient_raw, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to update usda_food_nutrient_raw row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "models: failed to get rows affected by update for usda_food_nutrient_raw")
	}
...
func (q usdaFoodNutrientRawQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to update all for usda_food_nutrient_raw")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to retrieve rows affected for usda_food_nutrient_raw")
	}
...
func (o UsdaFoodNutrientRawSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to update all in usdaFoodNutrientRaw slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to retrieve rows affected all in update all usdaFoodNutrientRaw")
	}
	return rowsAff, nil
}
...
func (o *UsdaFoodNutrientRaw) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("models: no usda_food_nutrient_raw provided for upsert")
	}
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("models: unable to upsert usda_food_nutrient_raw, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to upsert usda_food_nutrient_raw")
	}
...
func (o *UsdaFoodNutrientRaw) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("models: no UsdaFoodNutrientRaw provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to delete from usda_food_nutrient_raw")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "models: failed to get rows affected by delete for usda_food_nutrient_raw")
	}
...
func (q usdaFoodNutrientRawQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("models: no usdaFoodNutrientRawQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to delete all from usda_food_nutrient_raw")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "models: failed to get rows affected by deleteall for usda_food_nutrient_raw")
	}
...
func (o UsdaFoodNutrientRawSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to delete all from usdaFoodNutrientRaw slice")
	}
...
func (o *UsdaFoodNutrientRawSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to reload all in UsdaFoodNutrientRawSlice")
	}
...
func UsdaFoodNutrientRawExists(ctx context.Context, exec boil.ContextExecutor, iD int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "models: unable to check if usda_food_nutrient_raw exists")
	}
