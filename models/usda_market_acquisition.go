...
var (
	...
	usdaMarketAcquisitionColumnsWithoutDefault = []string{"fdc_id", "brand_description", "expiration_date", "label_weight", "location", "acquisition_date", "sales_type", "sample_lot_nbr", "sell_by_date", "store_city", "store_name", "store_state", "upc_code"}
	usdaMarketAcquisitionColumnsWithDefault    = []string{}
...
func UsdaMarketAcquisitions(mods ...qm.QueryMod) usdaMarketAcquisitionQuery {
	...
	return usdaMarketAcquisitionQuery{NewQuery(mods...)}
}
