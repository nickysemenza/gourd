...
var (
	...
	usdaFoodNutrientSourceColumnsWithoutDefault = []string{"id", "code", "description"}
	usdaFoodNutrientSourceColumnsWithDefault    = []string{}
...
func (o *UsdaFoodNutrientSource) SourceUsdaFoodNutrientDerivations(mods ...qm.QueryMod) usdaFoodNutrientDerivationQuery {
	...
	query := UsdaFoodNutrientDerivations(queryMods...)
	queries.SetFrom(query.Query, "\"usda_food_nutrient_derivation\"")

	if len(queries.GetSelect(query.Query)) == 0 {
		queries.SetSelect(query.Query, []string{"\"usda_food_nutrient_derivation\".*"})
	}
...
func UsdaFoodNutrientSources(mods ...qm.QueryMod) usdaFoodNutrientSourceQuery {
	...
	return usdaFoodNutrientSourceQuery{NewQuery(mods...)}
}
