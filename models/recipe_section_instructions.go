...
var (
	...
	recipeSectionInstructionColumnsWithoutDefault = []string{"id", "section_id"}
	recipeSectionInstructionColumnsWithDefault    = []string{"sort", "instruction"}
...
func RecipeSectionInstructions(mods ...qm.QueryMod) recipeSectionInstructionQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"\"recipe_section_instructions\".*"})
	}

	return recipeSectionInstructionQuery{q}
}
