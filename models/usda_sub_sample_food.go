...
var (
	...
	usdaSubSampleFoodColumnsWithoutDefault = []string{"fdc_id", "fdc_id_of_sample_food"}
	usdaSubSampleFoodColumnsWithDefault    = []string{}
...
func UsdaSubSampleFoods(mods ...qm.QueryMod) usdaSubSampleFoodQuery {
	...
	return usdaSubSampleFoodQuery{NewQuery(mods...)}
}
