...
var (
	...
	usdaRetentionFactorColumnsWithoutDefault = []string{"id", "code", "food_group_id", "description"}
	usdaRetentionFactorColumnsWithDefault    = []string{}
...
func (o *UsdaRetentionFactor) FoodGroup(mods ...qm.QueryMod) usdaFoodCategoryQuery {
	...
	query := UsdaFoodCategories(queryMods...)
	queries.SetFrom(query.Query, "\"usda_food_category\"")
...
func UsdaRetentionFactors(mods ...qm.QueryMod) usdaRetentionFactorQuery {
	...
	return usdaRetentionFactorQuery{NewQuery(mods...)}
}
