...
var (
	...
	usdaAgriculturalAcquisitionColumnsWithoutDefault = []string{"fdc_id", "acquisition_date", "market_class", "treatment", "state"}
	usdaAgriculturalAcquisitionColumnsWithDefault    = []string{}
...
func UsdaAgriculturalAcquisitions(mods ...qm.QueryMod) usdaAgriculturalAcquisitionQuery {
	...
	return usdaAgriculturalAcquisitionQuery{NewQuery(mods...)}
}
