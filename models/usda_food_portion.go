...
var (
	...
	usdaFoodPortionColumnsWithoutDefault = []string{"id", "fdc_id", "seq_num", "amount", "measure_unit_id", "portion_description", "modifier", "gram_weight", "data_points", "footnote", "min_year_acquired"}
	usdaFoodPortionColumnsWithDefault    = []string{}
...
func (q usdaFoodPortionQuery) One(ctx context.Context, exec boil.ContextExecutor) (*UsdaFoodPortion, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: failed to execute a one query for usda_food_portion")
	}
...
func (q usdaFoodPortionQuery) All(ctx context.Context, exec boil.ContextExecutor) (UsdaFoodPortionSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "models: failed to assign all query results to UsdaFoodPortion slice")
	}
...
func (q usdaFoodPortionQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "models: failed to count usda_food_portion rows")
	}
...
func (q usdaFoodPortionQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "models: failed to check if usda_food_portion exists")
	}
...
func (o *UsdaFoodPortion) MeasureUnit(mods ...qm.QueryMod) usdaMeasureUnitQuery {
	...
	query := UsdaMeasureUnits(queryMods...)
	queries.SetFrom(query.Query, "\"usda_measure_unit\"")
...
func UsdaFoodPortions(mods ...qm.QueryMod) usdaFoodPortionQuery {
	...
	return usdaFoodPortionQuery{NewQuery(mods...)}
}
...
func FindUsdaFoodPortion(ctx context.Context, exec boil.ContextExecutor, iD int, selectCols ...string) (*UsdaFoodPortion, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: unable to select from usda_food_portion")
	}
...
func (o *UsdaFoodPortion) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("models: no usda_food_portion provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to insert into usda_food_portion")
	}
...
func (o *UsdaFoodPortion) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("models: unable to update usda_food_portion, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to update usda_food_portion row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "models: failed to get rows affected by update for usda_food_portion")
	}
...
func (q usdaFoodPortionQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to update all for usda_food_portion")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to retrieve rows affected for usda_food_portion")
	}
...
func (o UsdaFoodPortionSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to update all in usdaFoodPortion slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to retrieve rows affected all in update all usdaFoodPortion")
	}
	return rowsAff, nil
}
...
func (o *UsdaFoodPortion) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("models: no usda_food_portion provided for upsert")
	}
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("models: unable to upsert usda_food_portion, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to upsert usda_food_portion")
	}
...
func (o *UsdaFoodPortion) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("models: no UsdaFoodPortion provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to delete from usda_food_portion")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "models: failed to get rows affected by delete for usda_food_portion")
	}
...
func (q usdaFoodPortionQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("models: no usdaFoodPortionQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to delete all from usda_food_portion")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "models: failed to get rows affected by deleteall for usda_food_portion")
	}
...
func (o UsdaFoodPortionSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to delete all from usdaFoodPortion slice")
	}
...
func (o *UsdaFoodPortionSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to reload all in UsdaFoodPortionSlice")
	}
...
func UsdaFoodPortionExists(ctx context.Context, exec boil.ContextExecutor, iD int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "models: unable to check if usda_food_portion exists")
	}
