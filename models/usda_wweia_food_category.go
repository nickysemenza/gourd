...
var (
	...
	usdaWweiaFoodCategoryColumnsWithoutDefault = []string{"wweia_food_category_code", "wweia_food_category_description"}
	usdaWweiaFoodCategoryColumnsWithDefault    = []string{}
...
func (q usdaWweiaFoodCategoryQuery) One(ctx context.Context, exec boil.ContextExecutor) (*UsdaWweiaFoodCategory, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: failed to execute a one query for usda_wweia_food_category")
	}
...
func (q usdaWweiaFoodCategoryQuery) All(ctx context.Context, exec boil.ContextExecutor) (UsdaWweiaFoodCategorySlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "models: failed to assign all query results to UsdaWweiaFoodCategory slice")
	}
...
func (q usdaWweiaFoodCategoryQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "models: failed to count usda_wweia_food_category rows")
	}
...
func (q usdaWweiaFoodCategoryQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "models: failed to check if usda_wweia_food_category exists")
	}
...
func (o *UsdaWweiaFoodCategory) WweiaCategoryCodeUsdaSurveyFNDDSFoods(mods ...qm.QueryMod) usdaSurveyFNDDSFoodQuery {
	...
	if len(queries.GetSelect(query.Query)) == 0 {
		queries.SetSelect(query.Query, []string{"\"usda_survey_fndds_food\".*"})
	}
...
func UsdaWweiaFoodCategories(mods ...qm.QueryMod) usdaWweiaFoodCategoryQuery {
	...
	return usdaWweiaFoodCategoryQuery{NewQuery(mods...)}
}
...
func FindUsdaWweiaFoodCategory(ctx context.Context, exec boil.ContextExecutor, wweiaFoodCategoryCode int, selectCols ...string) (*UsdaWweiaFoodCategory, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: unable to select from usda_wweia_food_category")
	}
...
func (o *UsdaWweiaFoodCategory) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("models: no usda_wweia_food_category provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to insert into usda_wweia_food_category")
	}
...
func (o *UsdaWweiaFoodCategory) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("models: unable to update usda_wweia_food_category, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to update usda_wweia_food_category row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "models: failed to get rows affected by update for usda_wweia_food_category")
	}
...
func (q usdaWweiaFoodCategoryQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to update all for usda_wweia_food_category")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to retrieve rows affected for usda_wweia_food_category")
	}
...
func (o UsdaWweiaFoodCategorySlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to update all in usdaWweiaFoodCategory slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to retrieve rows affected all in update all usdaWweiaFoodCategory")
	}
	return rowsAff, nil
}
...
func (o *UsdaWweiaFoodCategory) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("models: no usda_wweia_food_category provided for upsert")
	}
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("models: unable to upsert usda_wweia_food_category, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to upsert usda_wweia_food_category")
	}
...
func (o *UsdaWweiaFoodCategory) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("models: no UsdaWweiaFoodCategory provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to delete from usda_wweia_food_category")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "models: failed to get rows affected by delete for usda_wweia_food_category")
	}
...
func (q usdaWweiaFoodCategoryQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("models: no usdaWweiaFoodCategoryQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to delete all from usda_wweia_food_category")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "models: failed to get rows affected by deleteall for usda_wweia_food_category")
	}
...
func (o UsdaWweiaFoodCategorySlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to delete all from usdaWweiaFoodCategory slice")
	}
...
func (o *UsdaWweiaFoodCategorySlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to reload all in UsdaWweiaFoodCategorySlice")
	}
...
func UsdaWweiaFoodCategoryExists(ctx context.Context, exec boil.ContextExecutor, wweiaFoodCategoryCode int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "models: unable to check if usda_wweia_food_category exists")
	}
