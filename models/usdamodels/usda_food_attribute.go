...
var (
	...
	usdaFoodAttributeColumnsWithoutDefault = []string{"id"}
	usdaFoodAttributeColumnsWithDefault    = []string{"fdc_id", "seq_num", "food_attribute_type_id", "name", "value"}
	usdaFoodAttributePrimaryKeyColumns     = []string{"id"}
	usdaFoodAttributeGeneratedColumns      = []string{}
)
...
func (q usdaFoodAttributeQuery) One(ctx context.Context, exec boil.ContextExecutor) (*UsdaFoodAttribute, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "usdamodels: failed to execute a one query for usda_food_attribute")
	}
...
func (q usdaFoodAttributeQuery) All(ctx context.Context, exec boil.ContextExecutor) (UsdaFoodAttributeSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "usdamodels: failed to assign all query results to UsdaFoodAttribute slice")
	}
...
func (q usdaFoodAttributeQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "usdamodels: failed to count usda_food_attribute rows")
	}
...
func (q usdaFoodAttributeQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "usdamodels: failed to check if usda_food_attribute exists")
	}
...
func (o *UsdaFoodAttribute) FoodAttributeType(mods ...qm.QueryMod) usdaFoodAttributeTypeQuery {
	...
	return UsdaFoodAttributeTypes(queryMods...)
}
...
func UsdaFoodAttributes(mods ...qm.QueryMod) usdaFoodAttributeQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"\"usda_food_attribute\".*"})
	}

	return usdaFoodAttributeQuery{q}
}
...
func FindUsdaFoodAttribute(ctx context.Context, exec boil.ContextExecutor, iD int, selectCols ...string) (*UsdaFoodAttribute, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "usdamodels: unable to select from usda_food_attribute")
	}
...
func (o *UsdaFoodAttribute) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("usdamodels: no usda_food_attribute provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "usdamodels: unable to insert into usda_food_attribute")
	}
...
func (o *UsdaFoodAttribute) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("usdamodels: unable to update usda_food_attribute, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "usdamodels: unable to update usda_food_attribute row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "usdamodels: failed to get rows affected by update for usda_food_attribute")
	}
...
func (q usdaFoodAttributeQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "usdamodels: unable to update all for usda_food_attribute")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "usdamodels: unable to retrieve rows affected for usda_food_attribute")
	}
...
func (o UsdaFoodAttributeSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "usdamodels: unable to update all in usdaFoodAttribute slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "usdamodels: unable to retrieve rows affected all in update all usdaFoodAttribute")
	}
	return rowsAff, nil
}
...
func (o *UsdaFoodAttribute) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("usdamodels: no usda_food_attribute provided for upsert")
	}
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("usdamodels: unable to upsert usda_food_attribute, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "usdamodels: unable to upsert usda_food_attribute")
	}
...
func (o *UsdaFoodAttribute) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("usdamodels: no UsdaFoodAttribute provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "usdamodels: unable to delete from usda_food_attribute")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "usdamodels: failed to get rows affected by delete for usda_food_attribute")
	}
...
func (q usdaFoodAttributeQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("usdamodels: no usdaFoodAttributeQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "usdamodels: unable to delete all from usda_food_attribute")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "usdamodels: failed to get rows affected by deleteall for usda_food_attribute")
	}
...
func (o UsdaFoodAttributeSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "usdamodels: unable to delete all from usdaFoodAttribute slice")
	}
...
func (o *UsdaFoodAttributeSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "usdamodels: unable to reload all in UsdaFoodAttributeSlice")
	}
...
func UsdaFoodAttributeExists(ctx context.Context, exec boil.ContextExecutor, iD int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "usdamodels: unable to check if usda_food_attribute exists")
	}
