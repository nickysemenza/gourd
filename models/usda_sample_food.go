...
func (q usdaSampleFoodQuery) One(ctx context.Context, exec boil.ContextExecutor) (*UsdaSampleFood, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: failed to execute a one query for usda_sample_food")
	}
...
func (q usdaSampleFoodQuery) All(ctx context.Context, exec boil.ContextExecutor) (UsdaSampleFoodSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "models: failed to assign all query results to UsdaSampleFood slice")
	}
...
func (q usdaSampleFoodQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "models: failed to count usda_sample_food rows")
	}
...
func (q usdaSampleFoodQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "models: failed to check if usda_sample_food exists")
	}
...
func UsdaSampleFoods(mods ...qm.QueryMod) usdaSampleFoodQuery {
	...
	return usdaSampleFoodQuery{NewQuery(mods...)}
}
...
func FindUsdaSampleFood(ctx context.Context, exec boil.ContextExecutor, fDCID int, selectCols ...string) (*UsdaSampleFood, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "models: unable to select from usda_sample_food")
	}
...
func (o *UsdaSampleFood) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("models: no usda_sample_food provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to insert into usda_sample_food")
	}
...
func (o *UsdaSampleFood) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("models: unable to update usda_sample_food, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to update usda_sample_food row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "models: failed to get rows affected by update for usda_sample_food")
	}
...
func (q usdaSampleFoodQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to update all for usda_sample_food")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to retrieve rows affected for usda_sample_food")
	}
...
func (o UsdaSampleFoodSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to update all in usdaSampleFood slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to retrieve rows affected all in update all usdaSampleFood")
	}
	return rowsAff, nil
}
...
func (o *UsdaSampleFood) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("models: no usda_sample_food provided for upsert")
	}
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("models: unable to upsert usda_sample_food, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to upsert usda_sample_food")
	}
...
func (o *UsdaSampleFood) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("models: no UsdaSampleFood provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to delete from usda_sample_food")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "models: failed to get rows affected by delete for usda_sample_food")
	}
...
func (q usdaSampleFoodQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("models: no usdaSampleFoodQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to delete all from usda_sample_food")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "models: failed to get rows affected by deleteall for usda_sample_food")
	}
...
func (o UsdaSampleFoodSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "models: unable to delete all from usdaSampleFood slice")
	}
...
func (o *UsdaSampleFoodSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "models: unable to reload all in UsdaSampleFoodSlice")
	}
...
func UsdaSampleFoodExists(ctx context.Context, exec boil.ContextExecutor, fDCID int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "models: unable to check if usda_sample_food exists")
	}
