...
var (
	...
	usdaFoodNutrientDerivationColumnsWithoutDefault = []string{"id"}
	usdaFoodNutrientDerivationColumnsWithDefault    = []string{"code", "description", "source_id"}
	usdaFoodNutrientDerivationPrimaryKeyColumns     = []string{"id"}
	usdaFoodNutrientDerivationGeneratedColumns      = []string{}
)
...
func (q usdaFoodNutrientDerivationQuery) One(ctx context.Context, exec boil.ContextExecutor) (*UsdaFoodNutrientDerivation, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "usdamodels: failed to execute a one query for usda_food_nutrient_derivation")
	}
...
func (q usdaFoodNutrientDerivationQuery) All(ctx context.Context, exec boil.ContextExecutor) (UsdaFoodNutrientDerivationSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "usdamodels: failed to assign all query results to UsdaFoodNutrientDerivation slice")
	}
...
func (q usdaFoodNutrientDerivationQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "usdamodels: failed to count usda_food_nutrient_derivation rows")
	}
...
func (q usdaFoodNutrientDerivationQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "usdamodels: failed to check if usda_food_nutrient_derivation exists")
	}
...
func (o *UsdaFoodNutrientDerivation) Source(mods ...qm.QueryMod) usdaFoodNutrientSourceQuery {
	...
	return UsdaFoodNutrientSources(queryMods...)
}
...
func UsdaFoodNutrientDerivations(mods ...qm.QueryMod) usdaFoodNutrientDerivationQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"\"usda_food_nutrient_derivation\".*"})
	}

	return usdaFoodNutrientDerivationQuery{q}
}
...
func FindUsdaFoodNutrientDerivation(ctx context.Context, exec boil.ContextExecutor, iD int, selectCols ...string) (*UsdaFoodNutrientDerivation, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "usdamodels: unable to select from usda_food_nutrient_derivation")
	}
...
func (o *UsdaFoodNutrientDerivation) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("usdamodels: no usda_food_nutrient_derivation provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "usdamodels: unable to insert into usda_food_nutrient_derivation")
	}
...
func (o *UsdaFoodNutrientDerivation) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("usdamodels: unable to update usda_food_nutrient_derivation, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "usdamodels: unable to update usda_food_nutrient_derivation row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "usdamodels: failed to get rows affected by update for usda_food_nutrient_derivation")
	}
...
func (q usdaFoodNutrientDerivationQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "usdamodels: unable to update all for usda_food_nutrient_derivation")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "usdamodels: unable to retrieve rows affected for usda_food_nutrient_derivation")
	}
...
func (o UsdaFoodNutrientDerivationSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "usdamodels: unable to update all in usdaFoodNutrientDerivation slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "usdamodels: unable to retrieve rows affected all in update all usdaFoodNutrientDerivation")
	}
	return rowsAff, nil
}
...
func (o *UsdaFoodNutrientDerivation) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("usdamodels: no usda_food_nutrient_derivation provided for upsert")
	}
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("usdamodels: unable to upsert usda_food_nutrient_derivation, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "usdamodels: unable to upsert usda_food_nutrient_derivation")
	}
...
func (o *UsdaFoodNutrientDerivation) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("usdamodels: no UsdaFoodNutrientDerivation provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "usdamodels: unable to delete from usda_food_nutrient_derivation")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "usdamodels: failed to get rows affected by delete for usda_food_nutrient_derivation")
	}
...
func (q usdaFoodNutrientDerivationQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("usdamodels: no usdaFoodNutrientDerivationQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "usdamodels: unable to delete all from usda_food_nutrient_derivation")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "usdamodels: failed to get rows affected by deleteall for usda_food_nutrient_derivation")
	}
...
func (o UsdaFoodNutrientDerivationSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "usdamodels: unable to delete all from usdaFoodNutrientDerivation slice")
	}
...
func (o *UsdaFoodNutrientDerivationSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "usdamodels: unable to reload all in UsdaFoodNutrientDerivationSlice")
	}
...
func UsdaFoodNutrientDerivationExists(ctx context.Context, exec boil.ContextExecutor, iD int) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "usdamodels: unable to check if usda_food_nutrient_derivation exists")
	}
