...
CREATE INDEX IF NOT EXISTS idx_food_portion_fcd_id  ON usda_food_portion (fdc_id); -- new
...
CREATE TABLE IF NOT EXISTS usda_sub_sample_result (
  ...
  "lab_method_id"    INT REFERENCES usda_lab_method(id), -- XXX cannot use this because of broken refs: REFERENCES usda_lab_method(id),
  "nutrient_name"    TEXT
);
